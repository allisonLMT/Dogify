...
function Heart({ result }) {
    ...
    return (
        <div>
            ...
            {favorite === -1 ?
            <svg role="img" aria-labelledby="notFavorite" xmlns="http://www.w3.org/2000/svg" height="48" width="48" alt="add to Favorites" className={styles.notFav} onClick={() => {toggleFavorite(false, result)}}>
            ...
            <svg role="img" aria-labelledby="favorite" xmlns="http://www.w3.org/2000/svg" height="48" width="48" alt="remove from Favorites" className={styles.fav} onClick={() => {toggleFavorite(true, result)}}>
